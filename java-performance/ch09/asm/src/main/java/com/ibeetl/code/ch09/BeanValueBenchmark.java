...
import com.ibeetl.code.ch09.reflect.ReflectAttributeAccess;
import com.ibeetl.code.ch09.reflect.User;
...
public class BeanValueBenchmark {
	...
	ReflectAttributeAccess reflectAttributeAccess = null;
	...
	private void genReflect() throws Exception{
		reflectAttributeAccess = new ReflectAttributeAccess(User.class);
	}
    ...
    public Object byRelectBeans() {
       return  reflectAttributeAccess.value(user, "name");
    }
